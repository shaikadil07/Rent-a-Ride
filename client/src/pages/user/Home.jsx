...
function Home() {
  ...
  const { isSweetAlert } = useSelector(
    (state) => state.user
  );
    ...
    <>
      ...
      <div className="relative h-[100vh] w-full mx-auto sm:max-w-[900px] lg:max-w-[1500px] bg-white min-h-[72vh] md:min-h-[60vh] lg:min-h-[73vh]">
        ...
        >
          <div>
            <p
              className={`py-2 text-[9px] md:text-[12px] ${styles.paragraph}`}
            >
              Plan your trip now
            </p>
            ...
            >
              Save <span className="text-green-600">big</span> with our
              <br />
              car rental
            </h1>
      ...
      >
        ...
        <p className="text-gray-600 text-xl mb-8">
          Browse and book cars directly from owners.
        </p>

        <button
          onClick={() => navigate("/vehicles")}
          className="bg-green-500 hover:bg-green-600 text-white px-10 py-4 rounded-lg text-xl font-semibold shadow-lg"
        >
          Browse Vehicles
        </button>
      </div>
